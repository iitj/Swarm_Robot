...
//Date: 31/10/2011
/*This code is to communicate with an arduino board
This uses the POSIX Library
Original Code obtained from: http://todbot.com/blog/2006/12/06/arduino-serial-c-code-to-talk-to-arduino/
*/ 
#include <stdio.h>
